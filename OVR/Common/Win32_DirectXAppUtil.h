...
struct DirectX11
{
    ...
    static LRESULT CALLBACK BaseWindowProc(_In_ HWND hWnd, _In_ UINT Msg, _In_ WPARAM wParam, _In_ LPARAM lParam)
    {
    ...
    bool InitWindow(HINSTANCE hinst, LPCWSTR title, WNDPROC optionalWndProc = nullptr)
    {
        hInstance = hinst;
        Running = true;
        ...
        wc.style = CS_OWNDC;
        wc.lpfnWndProc = optionalWndProc ? optionalWndProc : BaseWindowProc;
